(function (e) {
    function t(t) {
        for (var a, i, s = t[0], c = t[1], d = t[2], u = 0, p = []; u < s.length; u++) i = s[u], n[i] && p.push(n[i][0]), n[i] = 0;
    ...
    var l = c;
    o.push([12, "chunk-vendors", "chunk-common"]), r()
})({
    12: function (e, t, r) {
        e.exports = r("4048")
    },
        ...
        var a = r("2b0e"),
            n = function () {
                var e = this,
                    t = e.$createElement,
                    r = e._self._c || t;
                return e.state.loading ? e._e() : r("div", {
                ...
                }, [e._v(e._s(e.playerBoard[0]))]), r("div", {
                    staticClass: "playerboard",
                    attrs: {
                        id: "player2"
                    }
                }, [e._v(e._s(e.playerBoard[1]))]), r("div", {
                    attrs: {
                        id: "stage"
                    }
                }, [r("transition", {
            ...
            l = {
                ...
                computed: {
                    ...
                    BoScore() {
                        const e = `url('../pic/score-board/UMEBURA/bo${this.tournament.bo}-0.png')`;
                        return {
                    ...
                    P1Score() {
                        const e = `url('../pic/score-board/UMEBURA/bo${this.tournament.bo}-${this.tournament.player[0].score}.png')`;
                        return {
                            "background-size": "contain",
                            "background-image": e,
                            "background-repeat": "no-repeat",
                    ...
                    P2Score() {
                        const e = `url('../pic/score-board/UMEBURA/bo${this.tournament.bo}-${this.tournament.player[1].score}.png')`;
                        return {
                            "background-size": "contain",
                            "background-image": e,
                            "background-repeat": "no-repeat",
            ...
            u = l,
            p = (r("a9bb"), r("2877")),
            b = Object(p["a"])(u, n, o, !1, null, null, null),
            y = b.exports;
